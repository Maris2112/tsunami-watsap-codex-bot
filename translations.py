...
T = {
    "ru": {
        ...
        "b_menu": "📋 Меню",
        "book_call": "🛏 Бронь топчана — только по телефону.\nПожалуйста, позвоните администратору: +7 777 719 5000 📞",
    ...
    "kk": {
        ...
        "b_menu": "📋 Мәзір",
        "book_call": "🛏 Топчан брондау — тек телефон арқылы.\nӘкімшіге қоңырау шалыңыз: +7 777 719 5000 📞",
    ...
    "en": {
        ...
        "b_menu": "📋 Menu",
        "book_call": "🛏 Lounger booking — by phone only.\nPlease call the administrator: +7 777 719 5000 📞",
